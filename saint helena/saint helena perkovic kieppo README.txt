...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=saint+helena+perkovic+kieppo&box=-5.568680,-15.825927,-5.849169,-16.095421
...
-----------
  ...
  * saint helena perkovic kieppo Height Map (ASTER 30m).png
  ...
  * saint helena perkovic kieppo Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * saint helena perkovic kieppo Height Map (SRTM3 v4.1).png
  ...
  * saint helena perkovic kieppo Height Map (SRTM30 Plus).png
